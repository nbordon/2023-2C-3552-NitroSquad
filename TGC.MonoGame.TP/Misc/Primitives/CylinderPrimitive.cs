    ...
    public class CylinderPrimitive : GeometricPrimitive
    {
            ...
            int tessellation = 32)
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(normal * radius + Vector3.Up * height, normal, new Vector2((float)i / tessellation, 0f));
                AddVertex(normal * radius + Vector3.Down * height, normal, new Vector2((float)i / tessellation, 1f));
        ...
        private void CreateCap(int tessellation, float height, float radius, Vector3 normal)
        {
            ...
            for (var i = 0; i < tessellation; i++)
            {
                ...
                AddVertex(position, normal, new Vector2((float)i / tessellation, 0f));
            }
        }

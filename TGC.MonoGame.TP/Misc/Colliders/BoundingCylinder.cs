...
namespace TGC.MonoGame.TP.Misc.Colliders
{
    ...
    /// </summary>
    class BoundingCylinder : BaseCollider
    {
		...
		/// </summary>
		public void UpdateCenter(Vector3 value)
		{
			Center = value;
			UpdateTranslation();
        ...
        public BoundingCylinder(Vector3 center, float radius, float halfLength)
        {
            ...
            IsXZAligned = true;
            Extents = new Vector3(radius, halfLength, radius) * 2f;
        ...
        {
            Rotation *= rotation;
            IsXZAligned = Rotation.Equals(Matrix.Identity);
            UpdateInverseRotation();
            UpdateTransform();
        }
        ...
        public ContainmentType Contains(Vector3 point)
        {
            ...
            if (MathF.Abs(Center.Y - transformedPoint.Y) > _halfHeight)
                return ContainmentType.Disjoint;

            var centerToPoint = transformedPoint - Center;
        ...
        private Vector3 ClosestPoint(Vector3 point)
        {
            ...
            var distanceY = uvwPoint.Y - Center.Y;
            if (MathF.Abs(distanceY) > _halfHeight)
                return Center + new Vector3(0, _halfHeight, 0) * Math.Sign(distanceY) + direction;

            var uvwResult = Center + new Vector3(0, distanceY, 0) + direction;
        ...
        public bool Intersects(BoundingSphere sphere)
        {
            ...
            centerToCenter.Y = _halfHeight * MathF.Sign(uvwSphereCenter.Y - Center.Y);
            centerToCenter += Center;
        ...
        public Vector3? Intersects(Vector3 pointA, Vector3 pointB)
        {
            ...
            var cylinderInit = Center - halfHeight;
            var cylinderEnd = Center + halfHeight;
        ...
        private BoxCylinderIntersection IntersectsXZAligned(BoundingBox box)
        {
            ...
            var centerDistance = new Vector2(Center.X - closestPoint.X, Center.Z - closestPoint.Z);
        ...
        ///     based on the contents of <see cref="Center"/>.
        /// </summary>
        private void UpdateTranslation()
        {
            _translation = Matrix.CreateTranslation(Center);
            _oppositeTranslation = Matrix.CreateTranslation(-Center);
        }
        ...
        /// <summary>
        ///     Updates the Inverse Rotation matrix, used in intersection tests, based on the values of <see cref="Rotation"/>, 
        ...
        /// <summary>
        ///     Updates the Transform and Inverse Transform matrices, based on the values of <see cref="_scale"/>, <see cref="Rotation"/> and <see cref="_translation"/>.
        /// </summary>
        private void UpdateTransform()
        {
            Transform = _scale * Rotation * _translation;

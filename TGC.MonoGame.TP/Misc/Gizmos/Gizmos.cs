...
using TGC.MonoGame.TP.Misc.Gizmos.Geometries;

namespace TGC.MonoGame.TP.Misc.Gizmos
{
    /// <summary>
    ///     Renders Gizmos
    /// </summary>
    public class Gizmos
    {
        ...
        public void LoadContent(GraphicsDevice device, ContentManager content)
        {
            ...
            AxisLines = new AxisLines(GraphicsDevice, Content.Load<Model>("Models/arrow"));
